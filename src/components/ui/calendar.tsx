    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-black text-white border-white p-0 opacity-50 hover:opacity-100"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 bg-black text-white hover:bg-white/10"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-white text-black hover:bg-white focus:bg-white focus:text-black",
